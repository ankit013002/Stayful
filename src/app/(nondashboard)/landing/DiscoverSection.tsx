...
const DiscoverSection = () => {
  return (
    ...
    >
      <div className="max-w-9xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16 text-center">
          {[
            ...
            },
            {
              ...
              description:
                "Once your've found the perfect rental property, easily book it online with just a few clicks.",
            },
            {
